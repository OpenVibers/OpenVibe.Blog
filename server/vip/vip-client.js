// Vendored verbatim from OpenVibe.VIP client/vip-client.js at 2accbeb (openvibe-vip/client). Replace with the
// pinned openvibe-vip package once VIP publishes a tag; do not edit here, change it in OpenVibe.VIP.
'use strict';
